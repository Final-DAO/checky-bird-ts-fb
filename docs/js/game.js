...
(function (Floppy) {
  ...
  Floppy.storage = {
    ...
    getHighScore: function () {
      ...
      return parseInt(
        (_a = window.localStorage.getItem("highscore")) !== null &&
          _a !== void 0
          ? _a
          : "0"
      );
...
(function (Floppy) {
  ...
  (function (Assets) {
    Assets.sounds = {
      ...
      swoosh: new Howl({
        src: ["assets/sounds/sfx_swooshing.ogg"],
        volume: 0.3,
      }),
    };
...
(function (Floppy) {
  var Bird = (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              this.position =
                this.flyingProperties.flightAreaBox.height - this.height;
              this.rotation = 90;
    ...
    Bird.prototype.tick = function () {
      ...
      this.box.width =
        this.width + widthMultiplier * Math.sin(rotationInRadians);
      this.box.height =
        this.height + heightMultiplier * Math.sin(rotationInRadians);
      var xShift = (this.width - this.box.width) / 2;
      var yShift = (this.height - this.box.height) / 2;
      this.box.x = 60 + xShift;
      this.box.y =
        this.position + yShift + this.flyingProperties.flightAreaBox.y;
    };
...
(function (Floppy) {
  var Game = (function () {
    function Game(domElements, options) {
      ...
      this.pipes = new Floppy.PipeManager(
        domElements.flightArea,
        options.isEasyModeOn
      );
    ...
    Object.defineProperty(Game.prototype, "currentScore", {
      ...
      set: function (newScore) {
        ...
        (_a = this.domElements.bigScore).replaceChildren.apply(
          _a,
          __spreadArray(
            [],
            __read(this.numberToImageElements(newScore, "big")),
            false
          )
        );
        (_b = this.domElements.currentScore).replaceChildren.apply(
          _b,
          __spreadArray(
            [],
            __read(this.numberToImageElements(newScore, "small")),
            false
          )
        );
      },
    ...
    Object.defineProperty(Game.prototype, "highScore", {
      ...
      set: function (newScore) {
        ...
        (_a = this.domElements.highScore).replaceChildren.apply(
          _a,
          __spreadArray(
            [],
            __read(this.numberToImageElements(newScore, "small")),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              Array.from(scoreboard.getElementsByClassName("visible")).forEach(
                function (e) {
                  return e.classList.remove("visible");
                }
              );
              ...
              this.bird.reset();
              this.currentScore = 0;
              Array.from(document.getElementsByClassName("animated")).forEach(
                function (e) {
          ...
          switch (_a.label) {
            ...
            case 3:
              ...
              if (wonMedal) {
                ...
                medal = new Image();
                medal.src = "assets/medal_" + wonMedal[1] + ".svg";
    ...
    Game.prototype.numberToImageElements = function (digits, size) {
      return digits
        ...
        .map(function (n) {
          ...
          imgDigit.src = "assets/font_" + size + "_" + n + ".svg";
          return imgDigit;
        });
    };
    Game.prototype.tick = function () {
      ...
      if (
        this.pipes.intersectsWith(this.bird.box) ||
        this.land.intersectsWith(this.bird.box)
      ) {
        this.die();
      }
    };
...
(function (Floppy) {
  var GameDebugger = (function () {
    ...
    GameDebugger.prototype.logStateChange = function (oldState, newState) {
      ...
      this.log(
        "Changing state",
        Floppy.Common.GameState[oldState],
        Floppy.Common.GameState[newState]
      );
    ...
    GameDebugger.prototype.log = function () {
      ...
      console.log.apply(
        console,
        __spreadArray(["[" + shortTime + "]"], __read(args), false)
      );
      this.domLogs.innerText +=
        "[" +
        shortTime +
        "] " +
        args
...
(function (Floppy) {
  var Pipe = (function () {
    ...
    Pipe.prototype.hasCrossed = function (box) {
      return (
        this.upperBox.width !== 0 &&
        this.upperBox.x + this.upperBox.width <= box.x
      );
    };
    Pipe.prototype.intersectsWith = function (box) {
      return (
        Helpers.isBoxIntersecting(this.upperBox, box) ||
        Helpers.isBoxIntersecting(this.lowerBox, box)
      );
    };
...
(function (Floppy) {
  var PipeManager = (function () {
    ...
    PipeManager.prototype.tick = function (now) {
      ...
      gameDebugger.log(
        "inserting pipe after",
        now - this.lastPipeInsertedTimestamp,
        "ms"
      );
    ...
    PipeManager.prototype.intersectsWith = function (box) {
      return (
        this.pipes.find(function (pipe) {
          return pipe.intersectsWith(box);
        }) != null
      );
    };
    PipeManager.prototype.removeAll = function () {
      this.pipes.forEach(function (pipe) {
        return pipe.domElement.remove();
      });
      this.pipes = [];
    };
    ...
    PipeManager.prototype.createPipeDimensions = function (options) {
      ...
      var topPipeHeight = this.randomNumberBetween(
        topPipeBuffer,
        bottomPipeBuffer
      );
...
(function () {
  ...
  var game = new Floppy.Game(
    ...
    { isDebugOn: isDebugOn, isEasyModeOn: isEasyModeOn }
  );
  document.onkeydown = function (ev) {
    ev.keyCode == 32 && game.onScreenTouch(ev);
  };
